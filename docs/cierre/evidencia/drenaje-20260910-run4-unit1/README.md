# Evaluación de drenaje 2026-09-10 — Run 4 — backend Unidad 1
...
- La corrida se ejecuta desde una copia limpia de HEAD `965dcac`; los únicos
  archivos nuevos son este harness y su evidencia. `source-manifest.sha256`
  identifica los archivos ejecutables del trayecto medido.
...
env PYTHONPATH=backend:. \
  ...
  backend/.venv/bin/python docs/cierre/evidencia/drenaje-20260910-run4-unit1/run_profile.py \
...
- `invalid-runs/`: intentos excluidos y causa comprobada.
