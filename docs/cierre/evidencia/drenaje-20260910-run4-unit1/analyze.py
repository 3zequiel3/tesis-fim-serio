#!/usr/bin/env python3
"""Derive transparent diagnostics from Run 4 metrics.jsonl."""
...
result = {
    ...
    "interpretation_limits": [
        ...
        "The harness stopped once all unique events were persisted and the local queue was empty.",
        "Unit 1 publishes event_ack and XACK atomically; both timestamps share the observable pipeline execute boundary, so their internal ordering is not measured separately.",
    ],
}
