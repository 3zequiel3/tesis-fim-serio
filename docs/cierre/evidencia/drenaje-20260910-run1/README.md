# Evaluación de drenaje 2026-09-10 — Run 1
...
env PYTHONPATH=backend:. \
  ...
  backend/.venv/bin/python docs/cierre/evidencia/drenaje-20260910-run1/run_profile.py \
  | tee docs/cierre/evidencia/drenaje-20260910-run1/stdout.log
