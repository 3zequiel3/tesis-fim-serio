...
- **WHEN** el usuario ingresa un nuevo password que cumple la política (≥12 chars, mayúscula, minúscula y número) y lo confirma
- **THEN** se envía `POST /users/change-password`
