...
#### Scenario: Alertas fallidas bajo el umbral no muestran banner
- **WHEN** la DLQ sólo contiene alertas con `retry_count < 3` y `GET /alerts/failed/count` retorna `count = 0`
