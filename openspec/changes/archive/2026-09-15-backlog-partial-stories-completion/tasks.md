...
- [x] 8.7 Antes y después de `openspec archive`: `python3 scripts/check_spec_integrity.py` (D47/RN-141); archivar este change antes que el Change 54, en serie (D-10)
