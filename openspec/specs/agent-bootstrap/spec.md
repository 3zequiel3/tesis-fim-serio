...
Capability: Bootstrap mTLS del agente FIM — generación de par de claves Ed25519, construcción de CSR, intercambio con el backend, y persistencia de certificado y secrets.
