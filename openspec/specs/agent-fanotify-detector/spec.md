# Spec: agent-fanotify-detector

Capability: Detector reactivo de cambios en el filesystem usando pyfanotify 0.3.0 — marcado FAN_MARK_FILESYSTEM, captura de contexto de proceso, comparación SHA-256 contra baseline, generación de diff textual, deduplicación por path y recarga en caliente de watch_paths.
