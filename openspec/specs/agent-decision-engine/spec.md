# Spec: agent-decision-engine

Capability: Motor de decisión del agente FIM — evalúa cambios detectados contra reglas glob cacheadas localmente, ejecuta acciones (auto_restore, quarantine, manual_review, alert_only) con journal transaccional pre/post-acción, rehidratación al arrancar y comportamiento offline.
