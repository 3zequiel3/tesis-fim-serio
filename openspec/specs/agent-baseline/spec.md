...
Capability: Motor de baseline cifrado AES-256-GCM del agente FIM — derivación de clave HKDF, cifrado por entrada, estados present/absent, snapshots FIFO con gzip, verificación de integridad y scan inicial.
