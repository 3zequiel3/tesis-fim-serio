# Evaluación de drenaje 2026-09-10 — Run 3
...
- Si el árbol no está limpio, `source-manifest.sha256` identifica los archivos
  ejecutables del trayecto medido; no se atribuye el resultado sólo a HEAD.
...
env PYTHONPATH=backend:. \
  ...
  backend/.venv/bin/python docs/cierre/evidencia/drenaje-20260910-run3/run_profile.py \
